    ...
    <div className="auth-screen">
      ...
      <div className="auth-form-wrap">
        <form
          ...
          noValidate
        >
          <span className="auth-logo auth-logo--center">
            <span className="auth-logo__mark" />
          </span>
          ...
          <div className="form-grid">
            <div className="field">
              ...
              <div
                className={`input-group ${
                  errors.firstName ? 'input-group--error' : ''
                }`}
              >
            ...
            <div className="field">
              ...
              <div
                className={`input-group ${
                  errors.lastName ? 'input-group--error' : ''
                }`}
              >
                <User size={18} className="input-group__icon" />
            ...
            <div className="field">
              ...
              <div
                className={`input-group ${
                  errors.employeeId ? 'input-group--error' : ''
                }`}
              >
                <Briefcase
                  size={18}
            ...
            <div className="field">
              ...
              <div
                className={`input-group ${
                  errors.phone ? 'input-group--error' : ''
                }`}
              >
            ...
            <div className="field field--span2">
              ...
              <div
                className={`input-group ${
                  errors.email ? 'input-group--error' : ''
                }`}
              >
            ...
            <div className="field">
              ...
              <div
                className={`input-group ${
                  errors.department ? 'input-group--error' : ''
                }`}
              >
                <Briefcase
                  size={18}
            ...
            <div className="field field--span2">
              ...
              <span className="password-note">
                You'll be asked to set a new password after your
                first login.
              </span>
            </div>
