  ...
  <div className="profile-history-table-box">
    <div className="table-scroll">
      <table className="vehicle-table">
        <thead>
          <tr>
            <th><span className="th-label">Vehicle</span></th>
            <th><span className="th-label">Customer</span></th>
            <th><span className="th-label">Date</span></th>
            <th><span className="th-label">Work Type</span></th>
            <th><span className="th-label">Completion Time</span></th>
            <th><span className="th-label">Rating</span></th>
