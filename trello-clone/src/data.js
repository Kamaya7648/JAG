export const STATUS_STYLES = {
  Received: { bg: '#E9E4FB', color: '#5B3FD9' },
  Diagnosis: { bg: '#DCEBFC', color: '#1D6FD1' },
  Repairing: { bg: '#FDE7D6', color: '#E8681A' },
  'Quality Check': { bg: '#FCF3D2', color: '#B8860B' },
  Completed: { bg: '#DFF5E6', color: '#1E8E4F' },
}
...
export const VEHICLES = [
  ...
  { id: '007', model: 'Mitsubishi Montero', plate: 'PQR-6789', status: 'Received', customerName: 'Sanduni Gunawardena', customerAddress: '31 Main Street, Kottawa', phone: '078-7890123' },
]
